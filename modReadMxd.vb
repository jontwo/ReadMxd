        ...
        Try
            ...
            While Not bDone And lRow < lMaxRows And lBlankRows < 10
                ...
                Select Case sCellVal.ToString.Trim.ToLower()
                    ...
                    Case "raster classify color ramp renderer"
                        If mxdProps.bRasterClassify Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "raster stretch color ramp renderer"
                        If mxdProps.bRasterStretch Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "raster discrete color renderer"
                        If mxdProps.bRasterDiscrete Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "raster rgb renderer"
                        If mxdProps.bRasterRGB Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "raster unique value renderer"
                        If mxdProps.bRasterUnique Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: standard deviations"
                        If mxdProps.bStretchStdDev Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: histogram equalize"
                        If mxdProps.bStretchHistEq Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: histogram specification"
                        If mxdProps.bStretchHistSpec Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: minimum maximum"
                        If mxdProps.bStretchMinMax Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: default"
                        If mxdProps.bStretchDefault Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: count"
                        If mxdProps.bStretchCount Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: custom"
                        If mxdProps.bStretchCount Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: esri"
                        If mxdProps.bStretchEsri Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: none"
                        If mxdProps.bStretchNone Then xlSheet1.Cells(lRow, lCol) = "x"
                    Case "stretch type: percent minimum maximum"
                        If mxdProps.bStretchPercent Then xlSheet1.Cells(lRow, lCol) = "x"
                        'end marker
                        'Case "volume"
                        '  bDone = True
                End Select
